...
```bash
npx create-server-development <project-name>
```

Or

```bash
npm init server-development <project-name>
```
...
```bash
git clone --depth 1 https://github.com/akshay-invennico/server-development.git
cd server-development
npx rimraf ./.git
```
...
# URL of the Mongo DB
MONGODB_URL=mongodb://127.0.0.1:27017/server-development
